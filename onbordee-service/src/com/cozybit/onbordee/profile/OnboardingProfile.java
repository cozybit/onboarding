package com.cozybit.onbordee.profile;
...
public class OnboardingProfile {
	...
	public enum EVENTS {
		...
		//High Level events related with the wifi connection establishment
		WIFI_CONNECTED("Connected to wifi network"), WIFI_DISCONNECTED("Disconnected from network"),
		//Lo level events related with the wifi connection establishment
